...
import type { AstViewState, FhirPathAst } from "../engine/types";
...
export class AstViewProvider implements vscode.WebviewViewProvider {
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		const scriptUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this._extensionUri, "media", "astView.js"),
		);
		...
		const styleMainUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this._extensionUri, "media", "astView.css"),
		);
